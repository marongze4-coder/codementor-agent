...
from backend.api.v1 import assignment, auth, code_review, defense, exam, qa, unified_chat
...
api_router.include_router(exam.router,         prefix="/mixed-assignments", tags=["综合作业三轨批改"])
